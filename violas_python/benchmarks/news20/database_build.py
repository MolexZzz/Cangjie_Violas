"""
20 Newsgroups Database building blocks

Similar to caltech-bench/database_build.py, provides:
- build_vectormap_from_train_data: Build VectorMap from training data
- build_milvus_collection_from_train_data: Build Milvus Collection
"""
import os
import sys
import time
...
def build_milvus_collection_from_train_data(train_data_by_key, collection_name="news_20", use_lite=True, host="localhost", port="19530"):
    ...
    schema = CollectionSchema(fields, "20news vector collection")
...
def build_qdrant_collection_from_train_data(train_data_by_key, collection_name="news_20", use_memory=True, host="localhost", port=6333):
...
def build_chroma_collection_from_train_data(train_data_by_key, collection_name="news_20"):
    print("\n=== Chroma Collection () ===")
