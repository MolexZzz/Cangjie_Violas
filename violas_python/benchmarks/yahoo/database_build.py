...
from yahoo_feature_extract import KeyPredictor
...
def build_milvus_collection_from_train_data(train_data_by_key, collection_name="yahoo_answer", use_lite=True, host="localhost", port="19530"):
    ...
    schema = CollectionSchema(fields, "Yahoo Answer text vector collection")
...
def build_qdrant_collection_from_train_data(train_data_by_key, collection_name="yahoo_answer", use_memory=True, host="localhost", port=6333):
    """Qdrant Collection"""
...
def build_chroma_collection_from_train_data(train_data_by_key, collection_name="yahoo_answer"):
    """Chroma Collection ()"""
    print("\n=== Chroma Collection () ===")
